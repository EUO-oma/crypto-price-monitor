...
-- Allow authenticated users to update their own entries (optional)
CREATE POLICY "Users can update anime" ON anime_board
    FOR UPDATE USING (true);

-- Allow authenticated users to delete (optional)
CREATE POLICY "Users can delete anime" ON anime_board
